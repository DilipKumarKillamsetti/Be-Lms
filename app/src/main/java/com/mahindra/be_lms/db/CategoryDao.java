...
public class CategoryDao extends AbstractDao<Category, Long> {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CATEGORY\" (" + //
                ...
                "\"CATEGORY_SEQUENCE\" TEXT);"); // 3: categorySequence
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Category entity) {
        ...
        String categorySequence = entity.getCategorySequence();
        if (categorySequence != null) {
            stmt.bindString(4, categorySequence);
        }
    }
    ...
    public Category readEntity(Cursor cursor, int offset) {
        Category entity = new Category( //
                ...
                cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3) // categorySequence
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Category entity, int offset) {
        ...
        entity.setCategorySequence(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
    }
    ...
    public static class Properties {
        ...
        public final static Property CategorySequence = new Property(3, String.class, "categorySequence", false, "CATEGORY_SEQUENCE");
    }
