...
import com.mahindra.be_lms.adapter.TechnicalUploadsByOtherAdapter;
 ...
 */
public class TechnicalDocumentByOtherFragment extends Fragment implements MyCallback, NetworkMethod {
    public static final String TAG = TechnicalDocumentByOtherFragment.class.getSimpleName();
    @BindView(R.id.rvTechnicalUploadByOther)
    RecyclerView rvTechnicalUploadByOther;
    @BindView(R.id.tvTechnicalDocumentByOtherFragmentRNF)
    TextView tvTechnicalDocumentByOtherFragmentRNF;
    ...
    private TechnicalUploadsByOtherAdapter adapter;
    private String download_url;
    @BindView(R.id.retryButtonLayout)
    LinearLayout retryButtonLayout;
    @BindView(R.id.btnRetry)
    Button btnRetry;
    public TechnicalDocumentByOtherFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_technical_document_by_other, container, false);
    ...
    private void init() {
        ...
        rvTechnicalUploadByOther.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false));
        rvTechnicalUploadByOther.setHasFixedSize(true);
        rvTechnicalUploadByOther.addItemDecoration(new DividerItemDecoration(getActivity(), DividerItemDecoration.VERTICAL_LIST));
        adapter = new TechnicalUploadsByOtherAdapter(getActivity(), technicalUploadList);
        rvTechnicalUploadByOther.setAdapter(adapter);
    ...
    private void callApi() {
        ...
        if (L.isNetworkAvailable(getActivity())) {
            if (retryButtonLayout.getVisibility() == View.VISIBLE) {
                ...
                rvTechnicalUploadByOther.setVisibility(View.VISIBLE);
            }
            request(Constants.BE_LMS_ROOT_URL+MyApplication.mySharedPreference.getUserToken()+"&wsfunction=custommobwebsrvices_otherstechnicalfiles&userid="+MyApplication.mySharedPreference.getUserId()+"&moodlewsrestformat=json");
        } else {
            retryButtonLayout.setVisibility(View.VISIBLE);
            rvTechnicalUploadByOther.setVisibility(View.GONE);
...
//                    }).show();
//
//            tvTechnicalDocumentByOtherFragmentRNF.setVisibility(View.VISIBLE);
        }
    }
...
//            }
    ...
    private void showImageDialog(TechnicalUpload technicalUpload) {
        ...
        Picasso.with(getActivity()).load(technicalUpload.getAttachmentList()).into(ivUploadedImage);
