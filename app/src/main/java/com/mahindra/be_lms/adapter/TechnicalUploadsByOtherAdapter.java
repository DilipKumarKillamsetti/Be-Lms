 ...
 */
public class TechnicalUploadsByOtherAdapter extends RecyclerView.Adapter<TechnicalUploadsByOtherAdapter.TUViewHolder> {
    private final Context context;
    private List<TechnicalUpload> technicalUploadList;
    private MyCallback myCallback;

    public TechnicalUploadsByOtherAdapter(Context context, List<TechnicalUpload> technicalUploadList) {
    ...
    public void onBindViewHolder(TUViewHolder holder, int position) {
        ...
        holder.tvTechnicalUploadUserInfo.setText(technicalUploadList.get(position).getUser());
        holder.tvTechnicalUploadUserInfo.setText("Uploaded By: "+technicalUploadList.get(position).getPosted_by());
        ...
        if (extension.equalsIgnoreCase("png")
            ...
            Picasso.with(context).load( technicalUploadList.get(position).getAttachmentList()).placeholder(R.drawable.icon_image).into(holder.ivTechnicalUploadIcon);
        }
    }
